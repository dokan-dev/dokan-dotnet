...
namespace DokanNet.Tests
{
    ...
    public static class Mounter
    {
        ...
        {
            (mounterThread = new Thread(new ThreadStart(() => DokanOperationsFixture.Operations.Mount(DokanOperationsFixture.MOUNT_POINT.ToString(CultureInfo.InvariantCulture), DokanOptions.DebugMode | DokanOptions.KeepAlive | DokanOptions.NetworkDrive, 1)))).Start();
