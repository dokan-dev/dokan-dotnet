    ...
    public class DokanNetTest
    {
        ...
        public void DokanIsNameInExpression_should_match_as_expected()
        {
            var tests = new MatchTest[] {
                ...
                new MatchTest( "*",                     "",                            false,  true,   true /* was false, BUT I DO BELIVE THIS TEST WAS WRONG */ ),
                new MatchTest( "**",                    "",                            false,  true,   true /* was false, BUT I DO BELIVE THIS TEST WAS WRONG */ ),
                ...
                new MatchTest( "C:\\DokanNet\\**",      "C:\\DokanNet\\dings.bmp",     false,  false,  true  ),
                new MatchTest( "C:\\DokanNet\\***",     "C:\\DokanNet\\dings.bmp",     false,  false,  true  ),
                new MatchTest( "C:\\Windows\\*a*",      "C:\\DokanNet\\dings.bmp",     false,  false,  false ),
                new MatchTest( "C:\\DokanNet\\*.bmp",   "C:\\Windows\\explorer.exe",   false,  false,  false ),
