...
fixture.SetupCreateFileWithoutCleanup(destinationPath, ReadWriteAccess | DeleteAccess | ChangePermissionsAccess, WriteShare, FileMode.OpenOrCreate, FileOptions.SequentialScan, attributes: FileAttributes.Normal);
#endif
