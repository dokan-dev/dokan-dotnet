...
namespace DokanNet
{
    public static class Extensions
    {
        ...
        public static Boolean IsFileSystemRunning(this Dokan dokanInstance)
        {
        ...
        public static UInt32 WaitForFileSystemClosed(this Dokan dokanInstance, UInt32 milliSeconds)
        {
